        ...
        try {
            ...
            while (sc.hasNextLine()) {
                ...
                PointPart pointPart_1 = 
                  ...
                  // simulation_0.getPartManager().createPointPart(new NeoObjectVector(new Object[]{region_0, boundary_0, boundary_1, boundary_2, boundary_3, boundary_4, boundary_5}), new DoubleVector(new double[]{x, y, z}));
                  // pointPart_0.getInputParts().setObjects(region_0, boundary_0, boundary_1, boundary_2, boundary_3, boundary_4, boundary_5);
