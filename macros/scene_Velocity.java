...
public class scene_Velocity extends StarMacro {
  ...
  private void execute0() {
    ...
    scene_3.setPresentationName("Copy of velocity_x");

    scene_3.copyProperties(scene_1);

    scene_3.initializeAndWait();

    scene_3.setPresentationName("velocity_mag");
    ...
    //   ((VectorComponentFieldFunction) primitiveFieldFunction_0.getMagnitudeFunction());
    // PrimitiveFieldFunction primitiveFieldFunction_0 = 
    //   ((PrimitiveFieldFunction) simulation_0.getFieldFunctionManager().getFunction("Velocity"));
    ...
    // scalarDisplayer_2.getScalarDisplayQuantity().setRange(new DoubleVector(new double[] {-0.05, 0.05}));
