// STAR-CCM+ macro: physics_VirtualDisks_PolyHedral.java
...
public class physics_VirtualDisks_PolyHedral extends StarMacro {
    ...
    // File f = new File("../inputs/" + simpleAnnotation_00.getText() + ".csv");    
      ...
      File f = new File("rotors.csv");    
        ...
        try {
            ...
            Logger.getLogger(physics_VirtualDisks_PolyHedral.class.getName()).log(Level.SEVERE, null, ex);
        } // end try
