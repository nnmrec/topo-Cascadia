...
public class mesh_Background_Polyhedral extends StarMacro {
  ...
  private void execute0() {
    ...
    AutoMeshOperation autoMeshOperation_0 = 
      simulation_0.get(MeshOperationManager.class).createAutoMeshOperation(new StringVector(new String[] {}), new NeoObjectVector(new Object[] {meshPart_0}));

    // SimpleBlockPart simpleBlockPart_0 = 
    //   // ((SimpleBlockPart) simulation_0.get(SimulationPartManager.class).getPart("Block"));
    //   ((SimpleBlockPart) simulation_0.get(SimulationPartManager.class).getPart("Subtract"));
    ...
    // surfaceCustomMeshControl_3.getGeometryObjects().setObjects(partSurface_2, partSurface_3, partSurface_1, partSurface_6);
    surfaceCustomMeshControl_3.getGeometryObjects().setObjects(partSurface_1,partSurface_2,partSurface_3,partSurface_4,partSurface_5);
