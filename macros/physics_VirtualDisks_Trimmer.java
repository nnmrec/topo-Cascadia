// STAR-CCM+ macro: physics_VirtualDisks_Trimmer.java
...
public class physics_VirtualDisks_Trimmer extends StarMacro {
    ...
    // File f = new File("../inputs/" + simpleAnnotation_00.getText() + ".csv");    
      ...
      File f = new File("rotors.csv");    
        ...
        try {
            ...
            Logger.getLogger(physics_VirtualDisks_Trimmer.class.getName()).log(Level.SEVERE, null, ex);
        } // end try
...
//                                    |___/                           
	    ...
	    //   // genericAbsoluteSize_6.getValue().setValue(rotor_radius[i]/40);
	    //   genericAbsoluteSize_6.getValue().setValue(rotor_radius[i]/20);
					    ...
					    // SimpleCylinderPart simpleCylinderPart_0 = 
					    //   ((SimpleCylinderPart) simulation_0.get(SimulationPartManager.class).getPart("refine cylinder (ccw_turbine-1)"));

					    volumeCustomMeshControl_1.getGeometryObjects().setObjects(simpleCylinderPart_0);

					    VolumeControlTrimmerSizeOption volumeControlTrimmerSizeOption_1 = 
					      volumeCustomMeshControl_1.getCustomConditions().get(VolumeControlTrimmerSizeOption.class);
					    ...
					    ((ScalarPhysicalQuantity) volumeControlSize_1.getAbsoluteSizeValue()).setValue(rotor_radius[i]/20);
