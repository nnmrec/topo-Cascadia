...
% this is a HACK! skip the uigetfile and read the filename hardcoded
% [pathname,filename,ext] = fileparts('/mnt/data-RAID-1/danny/ainlet_2006_3/OUT/ocean_his_0290.nc');
...
% colormap(othercolor('Blues6'))
nLevels = 32;
cmap    = colormap(bipolar(nLevels, 0.51));
colormap(cmap)
...
figName=[handles.vname,num2str(day),month,num2str(year),...
         '_z',num2str(handles.vlevel),'.png'];
disp(['export_fig file : ',figName])
% export_fig(figName, '–png', '-r200', '-a2'); 
export_fig(figName, '-r400', '-a2'); 
